...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="chClientList" checkbox="true" pagination="true" fitColumns="true" title="用户表" actionUrl="chClientController.do?datagrid" idField="id" sortName="createDate" fit="true" queryMode="group">
   ...
   <t:dgCol title="性别"  field="clientSex"  query="true"  queryMode="single" dictionary="sex" width="120"></t:dgCol>
   ...
   <t:dgCol title="头像"  field="clientHeadimg"  queryMode="single"  image="true" imageSize="50,50" formatterjs="btListImgFormatter" width="120"></t:dgCol>
   ...
   <t:dgCol title="是否VIP"  field="clientVip"  query="true"  queryMode="single" dictionary="sf_yn"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="chClientController.do?goAdd" funname="add"  width="768"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="chClientController.do?goUpdate" funname="update"  width="768"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="chClientController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="chClientController.do?goUpdate" funname="detail"  width="768"></t:dgToolBar>
