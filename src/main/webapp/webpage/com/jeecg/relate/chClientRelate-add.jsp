...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="chClientRelateController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
							<input id="clientId" name="clientId" type="text" style="width: 150px" class="searchbox-inputtext"  datatype="*"  ignore="checked"    />
				...
				<tr>
					...
					<td class="value">
							<input id="relateId" name="relateId" type="text" style="width: 150px" class="searchbox-inputtext"  datatype="*"  ignore="checked"    />
							<span class="Validform_checktip"></span>
