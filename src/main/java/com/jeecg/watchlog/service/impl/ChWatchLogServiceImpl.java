package com.jeecg.watchlog.service.impl;
...
@Service("chWatchLogService")
@Transactional
public class ChWatchLogServiceImpl extends CommonServiceImpl implements ChWatchLogServiceI {
