...
public class JwtRestfulClientDemo {
	...
	public static String getToken(String userName,String password){
		String url = "http://localhost:8080/rest/tokens?username="+userName+"&password="+password;
	...
	public static JSONObject getBlackList(String token){
		String url = "http://localhost:8080/rest/tsBlackListController";
	...
	public static JSONObject deleteBlackList(String token,String id){
		String url = "http://localhost:8080/rest/tsBlackListController/"+id;
